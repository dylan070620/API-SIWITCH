...
describe("useSettingsForm Hook", () => {
  ...
  it("should fold traditional chinese aliases into simplified chinese (zh-TW removed)", async () => {
    useSettingsQueryMock.mockReturnValue({
      data: {
        showInTray: true,
        minimizeToTrayOnClose: true,
    ...
    // i18n is already on "zh" (see beforeEach), so no redundant changeLanguage call is made.
